...
public class SortAscendingAction  extends AbstractAction{
	...
	public SortAscendingAction(DefaultMultipleDocumentModel multipleDocumentModel) {
		this.multipleDocumentModel = multipleDocumentModel;
		
		this.putValue(Action.NAME, LocalizationProvider.getInstance().getString("sortAscending"));
		this.putValue(Action.MNEMONIC_KEY, KeyEvent.VK_A);
		this.putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke("ctrl alt A"));
		this.putValue(Action.SHORT_DESCRIPTION, LocalizationProvider.getInstance().getString("sortAscendingDesc"));
	...
	public void actionPerformed(ActionEvent e) {
		if(this.enabled) {
			...
			selectedSplitted.sort(collator);
